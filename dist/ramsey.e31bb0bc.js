...
var returnStatement = document.querySelector('.returnStatement');
var modal = document.querySelector('.modal');

function handleSubmit(e) {
  e.preventDefault();
  var first = e.currentTarget.first.value;
  var last = e.currentTarget.last.value;
  var step = e.currentTarget.step.value;
  var content = getBabyFriends(step, data, first, last);
...
function getBabyFriends(step, friends, first, last) {
  var closeFriends = friends.filter(function (f) {
    return f[2] === step;
  });
...
function formatSentance(step, friends, first, last) {
  var message = "";
  var numOfFriends = friends.length;
  var formattedFriends = getNamesString(friends);
  var formattedFriends2 = getNamesString2(friends);

  if (numOfFriends === 1) {
    message = "\uD83C\uDF89Congratulations <span>".concat(first, " ").concat(last, "</span>\uD83C\uDF89<br> ").concat(formattedFriends, " is also in Baby Step #").concat(step, ".");
  } else if (numOfFriends === 1) {
    message = "\uD83C\uDF89Congratulations <span>".concat(first, " ").concat(last, "</span>\uD83C\uDF89 <br>").concat(formattedFriends, " are also in Baby Step #").concat(step, ".");
  } else if (numOfFriends > 1) {
...
function updateParagraph(content) {
  returnStatement.innerHTML = "".concat(content);
} // Handles Modal
...
//# sourceMappingURL=/ramsey.e31bb0bc.js.map